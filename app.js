    ...
    form.addEventListener("submit", (e) => {
        ...
        container.innerHTML = `
            <div class="form-success-message animate-fade-in" style="text-align:center; padding: 60px 20px;">
                <div class="form-success-icon" style="width:72px;height:72px;background:rgba(197,160,89,0.12);color:var(--accent);border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:36px;margin:0 auto 24px;">ðŸ›’</div>
...
function initInquiryForm() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        container.innerHTML = `
            <div class="form-success-message animate-fade-in" style="text-align:center;padding:60px 20px;">
                <div class="form-success-icon" style="width:72px;height:72px;background:rgba(16,185,129,0.1);color:var(--success);border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:36px;margin:0 auto 24px;">âœ“</div>
